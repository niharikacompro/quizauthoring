...
defineProps({
  variant: {
    type: String,
    default: 'default',
    validator: (value) => ['default', 'secondary', 'destructive', 'outline', 'ghost', 'link', 'glass'].includes(value)
  },
  size: {
    type: String,
    default: 'default',
  ...
  <button
    :class="[
      ...
      // Variants
      {
        ...
        'glass-button bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 shadow-lg': variant === 'glass',
        'glass-button-danger bg-rose-500/10 backdrop-blur-md border border-rose-500/20 hover:bg-rose-500/20': variant === 'glass-danger'
      },
      // Sizes
      {
