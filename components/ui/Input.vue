...
<template>
  <input
    ...
    :class="[
      ...
      // Variants
      {
        'border-input bg-background hover:border-primary/50': variant === 'default',
        'glass-input bg-white/5 backdrop-blur-sm border-white/10 hover:border-white/30': variant === 'glass',
        'border-transparent hover:bg-accent hover:text-accent-foreground': variant === 'ghost'
      },
      // Sizes
      {
